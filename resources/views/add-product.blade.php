<!doctype html>
<html lang="en">
<!-- Mirrored from bootstrap.gallery/cliq/add-product.blade.php by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 17 Sep 2022 08:40:22 GMT -->
<head>
    <meta charset="utf-8">
                    ...
                    <li class="sidebar-dropdown active"><a href="#"><i
                        ...
                        <div class="sidebar-submenu">
                            <ul>
                                ...
                                <li><a href="add-product.html" class="current-page">Add Product</a></li>
                        ...
                        <div class="card gradient-dark-grey">
                            ...
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
                                        <div class="product-block">
                                            ...
                                            <div class="product-body">
                                                <div class="row gutters">
                                                    <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
                                                        <div class="mb-3 control-dark"><label class="form-label">Product
                                                    ...
                                                    <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
                                                        <div class="mb-3 control-dark"><label class="form-label">Product
                                                                Category <span class="text-red">*</span></label><select
                                                                class="form-control">
                                                                <option value="Select Product Category">Select Product
                                                                    Category
                                                                </option>
                                                    ...
                                                    <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
                                                        <div class="mb-3 control-dark"><label class="form-label">Product
                                                                Price <span class="text-red">*</span></label><input
                                                                type="text" class="form-control"
                                                                placeholder="Enter Product Price"></div>
                                                    </div>
                                                    <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
                                                        <div class=" mb-3 control-dark"><label class="form-label">Product
                                                                Discount</label>
                                                    ...
                                                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                                                        <div class="mb-3 control-dark"><label class="form-label">Product
                                                                Description <span
                                                                    class="text-red">*</span></label><textarea rows="4"
                                                                                                               class="form-control"
                                    ...
                                    <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
                                        <div class="product-block">
                                            ...
                                            <div class="product-body">
                                                <div class="row gutters">
                                                    <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
                                                        <div class="mb-3 control-dark"><label class="form-label">Meta
                                                                Title <span class="text-red">*</span></label><input
                                                                type="text" class="form-control"
                                                    ...
                                                    <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
                                                        <div class="mb-3 control-dark"><label class="form-label">Meta
                                                                Name <span class="text-red">*</span></label><input
                                                                type="text" class="form-control"
                                                                placeholder="Enter Meta Name"></div>
                                                    </div>
                                                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                                                        <div class="mb-3 control-dark"><label class="form-label">Meta
                                                                Tags <span class="text-red">*</span></label><input
                                                                type="text" class="form-control"
                                                                placeholder="Enter Meta Tags"></div>
                                                    </div>
                                                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                                                        <div class="mb-3 control-dark"><label class="form-label">Meta
                                                                Description <span
                                    ...
                                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                                        <div class="product-block">
                                            <div class="product-title">Product Images</div>
                                            <div class="product-body">
                                                <div id="dropzone" class="dropzone-dark">
                                                    <form action="https://bootstrap.gallery/upload"
                                                        ...
                                                        <div class="dz-message needsclick">
                                                            ...
                                                            <br><span class="note needsclick">(This is just a demo dropzone. Selected files are <strong>not</strong>actually uploaded.)</span>
                                                        </div>
                                                    </form>
                                                </div>
                                            </div>
                                    ...
                                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                                        <div class="custom-btn-group flex-end">
                                            ...
                                            <a href="products.html" class="btn btn-success">Add Product</a></div>
                                    </div>
                                </div>
                            </div>
                        </div>
...
<!-- Mirrored from bootstrap.gallery/cliq/add-product.blade.php by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 17 Sep 2022 08:40:24 GMT -->
</html>
