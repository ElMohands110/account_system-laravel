...
@section('title', 'Exchange voucher registration')
@section('link1', 'Receipts')
@section('link2')
    <li class="breadcrumb-item breadcrumb-active" aria-current="page">Exchange voucher</li>
@endsection
...
@section('content')
        ...
        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
            <div class="card gradient-dark-grey">
                <div class="card-header">
                    <div class="card-title">Exchange voucher</div>
                    <a class="btn btn-warning" data-bs-toggle="modal" href="#exampleModalToggle" role="button">Registration exchange voucher</a>
                </div>
                <div class="card-body">
                                    ...
                                    <div class="modal-dialog modal-dialog-centered">
                                        <div class="modal-content modal-md">
                                            <div class="modal-header">
                                                <h4 class="modal-title">Delete Exchange voucher</h4>
                                            </div>
                                            <form action="{{ route('exchange_voucher_registration.destroy', $receipt->id) }}" method="POST" id="delfrm">
                                                @csrf
                                                <div class="modal-body">
                                                    <p>Are you sure want to delete it?</p><br>
                                ...
                                <div class="modal fade modal-dark" id="editModelExample{{ $receipt->id }}" aria-hidden="true" aria-labelledby="editModelExampleLabel{{ $receipt->id }}" tabindex="-1">
                                    <div class="modal-dialog modal-dialog-centered modal-xl">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                <h5 class="modal-title" id="editModelExampleLabel{{ $receipt->id }}">Edit exchange voucher</h5>
                                                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                                            </div>
                                            <div class="modal-body">
                                                <div class="col-md-12 col-sm-12 col-12">
                                                    <form action="{{ route('exchange_voucher_registration.update', $receipt->id) }}" method="POST">
                                                        @csrf
    ...
    <div class="modal fade modal-dark" id="exampleModalToggle" aria-hidden="true" aria-labelledby="exampleModalToggleLabel" tabindex="-1">
        <div class="modal-dialog modal-dialog-centered modal-xl">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalToggleLabel">Registration exchange voucher</h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body">
                    <div class="col-md-12 col-sm-12 col-12">
                        <form action="{{ route('exchange_voucher_registration.store') }}" method="POST">
