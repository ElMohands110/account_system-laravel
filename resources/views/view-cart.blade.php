<!doctype html>
<html lang="en">
<!-- Mirrored from bootstrap.gallery/cliq/view-cart.blade.php by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 17 Sep 2022 08:40:18 GMT -->
<head>
    <meta charset="utf-8">
                    ...
                    <li class="sidebar-dropdown active"><a href="#"><i
                        ...
                        <div class="sidebar-submenu">
                            <ul>
                                ...
                                <li><a href="view-cart.html" class="current-page">Shopping Cart</a></li>
                    ...
                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                        <div class="card gradient-dark-grey">
                            <div class="card-header">
                                ...
                                <div class="ml-auto"><a href="products.html" class="btn btn-success"><i
                                            class="icon-arrow_back_ios"></i>Back to Products</a></div>
                            </div>
                            <div class="card-body">
                                <div class="row gutters">
                                    <div class="col-xxl-6 col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                                        <div class="product-added-card"><img class="product-added-img"
                                                                             src="img/food/img7.jpg" alt="Cliq Admin">
                                            <div class="product-added-card-body"><h5 class="product-added-title">
                                                    Barbecue Chicken Salad</h5>
                                                <div class="product-added-price">$25.00</div>
                                                <div class="product-added-description">Lettuce, cucumbers, tomatoes,
                                                    scallions, corn, chicken with tangy barbecue ranch dressing.
                                                </div>
                                                <div class="product-added-actions">
                                                    <button class="btn btn-dark remove-from-cart">Remove from Cart
                                                    </button>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="col-xxl-6 col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                                        <div class="product-added-card"><img class="product-added-img"
                                                                             src="img/food/img9.jpg" alt="Cliq Admin">
                                            <div class="product-added-card-body"><h5 class="product-added-title">Harvest
                                                    Cobb Salad</h5>
                                    ...
                                    <div class="col-xxl-6 col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                                        <div class="product-added-card"><img class="product-added-img"
                                                                             src="img/food/img2.jpg" alt="Cliq Admin">
                                            <div class="product-added-card-body"><h5 class="product-added-title">Greek
                                                    Salad</h5>
                                                <div class="product-added-price">$28.00</div>
                                                <div class="product-added-description">Lettuce, cucumbers, tomatoes,
                                                    chicken with tangy barbecue ranch dressing.
                                                </div>
                                                <div class="product-added-actions">
                                                    <button class="btn btn-dark remove-from-cart">Remove from Cart
                                                    </button>
                                    ...
                                    <div class="col-xxl-6 col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                                        <div class="product-added-card"><img class="product-added-img"
                                                                             src="img/food/img6.jpg" alt="Cliq Admin">
                                            <div class="product-added-card-body"><h5 class="product-added-title">Garden
                                                    Chickpea Salad</h5>
                                                <div class="product-added-price">$22.00</div>
                                                <div class="product-added-description">Perfect for vegetarian and
                                                    buffets, this is a job of gorgeous ingredients.
                                                </div>
                                                <div class="product-added-actions">
                                                    <button class="btn btn-dark remove-from-cart">Remove from Cart
                                                    </button>
                                    ...
                                    <div class="col-xxl-12 col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                                        <div class="sub-total-container">
                                            ...
                                            <a href="checkout.html" class="btn btn-success btn-lg">Checkout</a></div>
                                    </div>
                                </div>
                            </div>
                        </div>
