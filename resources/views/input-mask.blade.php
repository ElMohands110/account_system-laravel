<!doctype html>
<html lang="en">
<!-- Mirrored from bootstrap.gallery/cliq/input-mask.blade.php by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 17 Sep 2022 08:40:44 GMT -->
<head>
    <meta charset="utf-8">
                    ...
                    <li class="sidebar-dropdown active"><a href="#"><i class="icon-edit_road gradient-yellow"></i><span
                        ...
                        <div class="sidebar-submenu">
                            <ul>
                                ...
                                <li><a href="input-mask.html" class="current-page">Input Masks</a></li>
                                    ...
                                    <div class="col-xl-3 col-lg-3 col-md-3 col-sm-3 col-12">
                                        <div class="mb-3 control-dark">
                                            ...
                                            <input type="text" class="form-control"
                                                   placeholder="Enter credit card number" id="input-credit-card"/>
                                            <div id="creditCardType">
                                                <div class="visa credit-card"><img src="img/cards/mastercard.png"
                                                                                   alt="Uni Pro Admin"/></div>
                                                <div class="mastercard credit-card"><img src="img/cards/visa.png"
                                                                                         alt="Uni Pro Admin"/></div>
                                                <div class="amex credit-card"><img src="img/cards/american-express.png"
                                                                                   alt="Uni Pro Admin"/></div>
                                                <div class="jcb credit-card"><img src="img/cards/jcb.png"
                                                                                  alt="Uni Pro Admin"/></div>
                                                <div class="diners credit-card"><img src="img/cards/diners.png"
                                                                                     alt="Uni Pro Admin"/></div>
                                                <div class="discover credit-card"><img src="img/cards/discover.png"
                                                                                       alt="Uni Pro Admin"/></div>
                                            </div>
                                        </div>
                                    </div>
                        ...
                        <div class="card gradient-dark-grey">
                            <div class="card-body">
                                <div class="row gutters">
                                    <div class="col-xl-3 col-lg-3 col-md-3 col-sm-3 col-12">
                                        <div class="mb-3 control-dark">
                                            <div class="input-group"><span class="input-group-text">US (+1)</span><input
                                                    type="text" class="form-control" placeholder="Enter phone number"
                                                    id="phone-format-us"/></div>
                                        </div>
                                    </div>
                                    <div class="col-xl-3 col-lg-3 col-md-3 col-sm-3 col-12">
                                        <div class="mb-3 control-dark">
                                            <div class="input-group"><span
                                                    class="input-group-text">IND (+91)</span><input type="text"
                                                                                                    class="form-control"
                                    ...
                                    <div class="col-xl-3 col-lg-3 col-md-3 col-sm-3 col-12">
                                        <div class="mb-3 control-dark">
                                            <div class="input-group"><span
                                                    class="input-group-text">BRZ (+55)</span><input type="text"
                                                                                                    class="form-control"
                                                                                                    placeholder="Enter phone number"
                                                                                                    id="phone-format-br"/>
                                            </div>
                                    ...
                                    <div class="col-xl-3 col-lg-3 col-md-3 col-sm-3 col-12">
                                        <div class="mb-3 control-dark">
                                            ...
                                            <input type="text" class="form-control" placeholder="Enter Number"
                                                   id="input-numeral-thousand"/></div>
                                    </div>
                                    <div class="col-xl-3 col-lg-3 col-md-3 col-sm-3 col-12">
                                        <div class="mb-3 control-dark">
                                            <div class="form-label">Input Numeral Lakh Format</div>
                                            <input type="text" class="form-control" placeholder="Enter Number"
                                                   id="input-numeral-lakh"/></div>
                                    </div>
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="row gutters">
                                    <div class="col-xl-3 col-lg-3 col-md-3 col-sm-3 col-12">
                                        <div class="mb-3 control-dark">
                                            ...
                                            <input type="text" class="form-control"
                                                   placeholder="Delimiters: [4444.333.333.4444]" id="input-blocks"/>
                                        </div>
                                    </div>
                                    <div class="col-xl-3 col-lg-3 col-md-3 col-sm-3 col-12">
                                        <div class="mb-3 control-dark">
                                            ...
                                            <input type="text" class="form-control"
                                                   placeholder="Delimiters: [333.333.333]" id="input-delimiter"/></div>
                                    </div>
                                    <div class="col-xl-3 col-lg-3 col-md-3 col-sm-3 col-12">
                                        <div class="mb-3 control-dark">
                                            <div class="form-label">Delimiter</div>
                                            <input type="text" class="form-control"
                                                   placeholder="Delimiters: [333.333.333.22]" id="input-delimiter2"/>
                                        </div>
                                    </div>
                                    <div class="col-xl-3 col-lg-3 col-md-3 col-sm-3 col-12">
                                        <div class="mb-3 control-dark">
                                            ...
                                            <input type="text" class="form-control"
                                                   placeholder="Delimiters: [4444.4444.4444]" id="input-prefix"/></div>
                                    </div>
                                </div>
                            </div>
                        </div>
...
<!-- Mirrored from bootstrap.gallery/cliq/input-mask.blade.php by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 17 Sep 2022 08:40:57 GMT -->
</html>
