<!doctype html>
<html lang="en">
<!-- Mirrored from bootstrap.gallery/cliq/reviews.blade.php by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 17 Sep 2022 08:40:24 GMT -->
<head>
    <meta charset="utf-8">
                    ...
                    <li class="sidebar-dropdown active"><a href="#"><i
                        ...
                        <div class="sidebar-submenu">
                            <ul>
                                ...
                                <li><a href="reviews.html" class="current-page">Reviews</a></li>
                            </ul>
                        </div>
                    </li>
        ...
        <div class="page-header">
            <div class="breadcrumb-container">
                ...
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item breadcrumb-active" aria-current="page">Reviews</li>
                </ol>
            </div>
                            ...
                            <div class="card-body">
                                <div class="table-responsive">
                                    <table class="table v-middle">
                                        ...
                                        <tr>
                                            <td>
                                                <div class="media-box"><img src="img/user2.png" class="media-avatar"
                                                                            alt="User">
                                                    <div class="media-box-body"><a href="#" class="text-truncate">Tiya
                                                            Nixon</a></div>
                                                </div>
                                            </td>
                                            <td>
                                                <div class="media-box"><img src="img/food/img1.jpg"
                                                                            class="media-avatar-lg" alt="Product">
                                                    <div class="media-box-body"><a href="#" class="text-truncate">Leather
                                                            Backpack</a>
                                                        <p>ID: #FLM00987</p>
                                            ...
                                            <td>10/11/2021</td>
                                            <td>Great Product. Very happy with the purchase and will surely shop for
                                                more with Leather Villa in the time to come.
                                            </td>
                                        </tr>
                                        <tr>
                                            <td>
                                                <div class="media-box"><img src="img/user3.png" class="media-avatar"
                                                                            alt="User">
                                                    <div class="media-box-body"><a href="#" class="text-truncate">Garrett
                                                            Winters</a></div>
                                                </div>
                                            </td>
                                            <td>
                                                <div class="media-box"><img src="img/food/img2.jpg"
                                                                            class="media-avatar-lg" alt="Product">
                                                    <div class="media-box-body"><a href="#" class="text-truncate">DSLR
                                                            Camera</a>
                                                        <p>ID: #FLM00990</p>
                                                        <div class="rating-block">
                                                            <div class="rate1"></div>
                                            ...
                                            <td>16/10/2021</td>
                                            <td>This camera is a perfect choice if you are a beginner. The price range
                                                is decent, the camera is user friendly.
                                            </td>
                                        </tr>
                                        <tr>
                                            <td>
                                                <div class="media-box"><img src="img/user4.png" class="media-avatar"
                                                                            alt="User">
                                            ...
                                            <td>
                                                <div class="media-box"><img src="img/food/img3.jpg"
                                                                            class="media-avatar-lg" alt="Product">
                                                    <div class="media-box-body">
                                            ...
                                            <td>24/11/2021</td>
                                            <td>Awesome Product. This is a good size for a classroom clock. We added a
                                                new room to our school and this clock fits our needs wonderfully.
                                            </td>
                                        </tr>
                                        <tr>
                                            <td>
                                                <div class="media-box"><img src="img/user5.png" class="media-avatar"
                                                                            alt="User">
                                                    <div class="media-box-body">
                                            ...
                                            <td>
                                                <div class="media-box"><img src="img/food/img4.jpg"
                                                                            class="media-avatar-lg" alt="Product">
                                                    <div class="media-box-body">
                                            ...
                                            <td>27/10/2021</td>
                                            <td>Five Starts. This drone literally has too many pro's to list, they call
                                                it a pro for a reason.
                                            </td>
                                        </tr>
                                        <tr>
                                            <td>
                                                <div class="media-box"><img src="img/user6.png" class="media-avatar"
                                                                            alt="User">
                                                    <div class="media-box-body">
                                            ...
                                            <td>
                                                <div class="media-box"><img src="img/food/img5.jpg"
                                                                            class="media-avatar-lg" alt="Product">
                                                    <div class="media-box-body">
                                            ...
                                            <td>09/11/2021</td>
                                            <td>Great product! My kids really love how many things they can build. Hours
                                                and hours of fun ahead with this toy. The parts are great quality and
...
<!-- Mirrored from bootstrap.gallery/cliq/reviews.blade.php by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 17 Sep 2022 08:40:25 GMT -->
</html>
