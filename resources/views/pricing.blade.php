<!doctype html>
<html lang="en">
<!-- Mirrored from bootstrap.gallery/cliq/pricing.blade.php by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 17 Sep 2022 08:40:43 GMT -->
<head>
    <meta charset="utf-8">
                    ...
                    <li class="sidebar-dropdown active"><a href="#"><i
                        ...
                        <div class="sidebar-submenu">
                            <ul>
                                ...
                                <li><a href="pricing.html" class="current-page">Pricing</a></li>
        ...
        <div class="page-header">
            <div class="breadcrumb-container">
                ...
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item breadcrumb-active" aria-current="page">Pricing Plans</li>
                </ol>
            </div>
                    ...
                    <div class="container">
                        <div class="row gutters justify-content-center">
                            <div class="col-xl-3 col-lg-3 col-md-3 col-sm-4 col-12">
                                <div class="pricing-plan gradient-teal">
                                    <div class="pricing-header"><h4 class="pricing-title">Basic</h4>
                                    ...
                                    <div class="pricing-body">
                                        ...
                                        <div class="pricing-footer"><a href="#" class="btn btn-light btn-lg">Select
                                                Plan</a></div>
                                    </div>
                                </div>
                            </div>
                            <div class="col-xl-3 col-lg-3 col-md-3 col-sm-4 col-12">
                                <div class="pricing-plan gradient-green">
                                    <div class="pricing-header"><h4 class="pricing-title">Business</h4>
                            ...
                            <div class="col-xl-3 col-lg-3 col-md-3 col-sm-4 col-12">
                                <div class="pricing-plan gradient-peach">
                                    <div class="pricing-header"><h4 class="pricing-title">Enterprise</h4>
