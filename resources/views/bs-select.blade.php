<!doctype html>
<html lang="en">
<!-- Mirrored from bootstrap.gallery/cliq/bs-select.blade.php by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 17 Sep 2022 08:40:44 GMT -->
<head>
    <meta charset="utf-8">
                    ...
                    <li class="sidebar-dropdown active"><a href="#"><i class="icon-edit_road gradient-yellow"></i><span
                        ...
                        <div class="sidebar-submenu">
                            <ul>
                                ...
                                <li><a href="bs-select.html" class="current-page">Bootstrap Select</a></li>
        ...
        <div class="page-header">
            <div class="breadcrumb-container">
                ...
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item breadcrumb-active" aria-current="page">Bootstrap Select</li>
                </ol>
            </div>
                            ...
                            <div class="card-body">
                                <div class="row gutters">
                                    <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
                                        <div class="mb-3"><label class="form-label">Single Select</label><select
                                            class="select-single js-states form-control" title="Select Product Category"
                                    ...
                                    <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
                                        <div class="mb-3"><label class="form-label">Multi Select</label><select
                                            class="select-multiple js-states form-control"
                                            title="Select Product Category" multiple="multiple">
                                            <option>Mobiles</option>
                                            <option>Books</option>
                                            <option>Clothing</option>
                                            <option>Electronics</option>
                                    ...
                                    <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
                                        <div class="mb-3"><label class="form-label">Disabled Select Field</label><select
                                            class="select-single js-states form-control" title="Select Product Category"
                                    ...
                                    <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
                                        <div class="mb-3"><label class="form-label">Disabled Multi Select</label><select
                                            class="select-multiple js-states form-control"
                                            title="Select Product Category" multiple="multiple" disabled="">
                                            <option>Mobiles</option>
                                            <option>Books</option>
                                            <option>Clothing</option>
                                            <option>Electronics</option>
                                    ...
                                    <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
                                        <div class="mb-3"><label class="form-label">Placeholder</label><select
                                            class="select-single select-placeholder js-states form-control"
                                            multiple="multiple">
                                            <option>Mobiles</option>
                                            <option>Books</option>
                                            <option>Clothing</option>
                                    ...
                                    <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
                                        <div class="mb-3"><label class="form-label">Tokenization Tags</label><select
                                            class="select-tokenizer js-states form-control"
                                            multiple="multiple"></select></div>
                                    </div>
                                    <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
                                        <div class="mb-3"><label class="form-label">Opt Groups</label><select
                                            class="select-single js-states form-control" title="Select Product Category"
                                            data-live-search="true">
                                    ...
                                    <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
                                        <div class="mb-3"><label class="form-label">Opt Groups Multiple</label><select
                                            class="select-multiple js-states form-control"
                                            title="Select Product Category" multiple="multiple">
                                            <optgroup label="Mobiles">
                                                <option>Apple</option>
