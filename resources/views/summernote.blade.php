<!doctype html>
<html lang="en">
<!-- Mirrored from bootstrap.gallery/cliq/summernote.blade.php by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 17 Sep 2022 08:40:57 GMT -->
<head>
    <meta charset="utf-8">
                    ...
                    <li class="sidebar-dropdown active"><a href="#"><i class="icon-edit_road gradient-yellow"></i><span
                        ...
                        <div class="sidebar-submenu">
                            <ul>
                                ...
                                <li><a href="summernote.html" class="current-page">Summernote</a></li>
                            </ul>
                        </div>
                    </li>
        ...
        <div class="page-header">
            <div class="breadcrumb-container">
                ...
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item breadcrumb-active" aria-current="page">Summernote Editor</li>
                </ol>
            </div>
...
<script>// Summernote$(document).ready (function (){$('.summernote').summernote ({height: 300,tabsize: 2,focus: true,toolbar: [['font', ['bold', 'underline', 'clear']],['para', ['ul', 'ol']],['insert', ['link', 'picture', 'video']],['view', ['fullscreen', 'codeview', 'help']],]});});</script>
</body>
<!-- Mirrored from bootstrap.gallery/cliq/summernote.blade.php by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 17 Sep 2022 08:40:59 GMT -->
</html>
