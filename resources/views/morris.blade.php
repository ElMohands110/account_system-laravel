<!doctype html>
<html lang="en">
<!-- Mirrored from bootstrap.gallery/cliq/morris.blade.php by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 17 Sep 2022 08:41:21 GMT -->
<head>
    <meta charset="utf-8">
            ...
            <div class="sidebar-menu">
                <ul>
                    ...
                    <li class="sidebar-dropdown active"><a href="#"><i
                                class="icon-pie_chart_outlined gradient-blue"></i><span class="menu-text">Graphs</span></a>
                        <div class="sidebar-submenu">
                            <ul>
                                <li><a href="apex.html">Apex</a></li>
                                <li><a href="morris.html" class="current-page">Morris</a></li>
        ...
        <div class="page-header">
            <div class="breadcrumb-container">
                ...
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item breadcrumb-active" aria-current="page">Morris Graphs</li>
                </ol>
            </div>
        ...
        <div class="content-wrapper-scroll">
            <div class="content-wrapper">
                <div class="row gutters">
                    ...
                    <div class="col-xl-4 col-lg-4 col-md-6 col-sm-6 col-12">
                        <div class="card gradient-peach3">
                            <div class="card-body">
...
<!-- Mirrored from bootstrap.gallery/cliq/morris.blade.php by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 17 Sep 2022 08:41:38 GMT -->
</html>
