<!doctype html>
<html lang="en">
<!-- Mirrored from bootstrap.gallery/cliq/date-time-pickers.blade.php by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 17 Sep 2022 08:40:44 GMT -->
<head>
    <meta charset="utf-8">
                    ...
                    <li class="sidebar-dropdown active"><a href="#"><i class="icon-edit_road gradient-yellow"></i><span
                        ...
                        <div class="sidebar-submenu">
                            <ul>
                                ...
                                <li><a href="date-time-pickers.html" class="current-page">Date Time Pickers</a></li>
        ...
        <div class="page-header">
            <div class="breadcrumb-container">
                ...
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item breadcrumb-active" aria-current="page">Date Time Picker</li>
                </ol>
            </div>
            ...
            <div class="content-wrapper">
                <div class="row gutters">
                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                        <div class="card card gradient-dark-grey">
                            <div class="card-body">
                                <div class="row gutters">
                                    <div class="col-xl-4 col-lg-4 col-md-6 col-sm-6 col-12">
                                        <div class="mb-3">
                                            ...
                                            <div class="input-group control-dark"><input type="text"
                                                                                         class="form-control custom-daterange"><span
                                    ...
                                    <div class="col-xl-4 col-lg-4 col-md-6 col-sm-6 col-12">
                                        <div class="mb-3">
                                            ...
                                            <div class="input-group control-dark"><input type="text"
                                                                                         class="form-control custom-daterange2"><span
                                                    class="input-group-text"><i class="icon-date_range"></i></span>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="row gutters">
                                    ...
                                    <div class="col-xl-4 col-lg-4 col-md-6 col-sm-6 col-12">
                                        <div class="mb-3">
                                            ...
                                            <div class="input-group control-dark"><input type="text"
                                                                                         class="form-control datepicker-week-numbers"><span
                                                    class="input-group-text"><i class="icon-date_range"></i></span>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-xl-4 col-lg-4 col-md-6 col-sm-6 col-12">
                                        <div class="mb-3">
                                            ...
                                            <div class="input-group control-dark"><input type="text"
                                                                                         class="form-control datepicker-iso-week-numbers"><span
                                                    class="input-group-text"><i class="icon-date_range"></i></span>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-xl-4 col-lg-4 col-md-6 col-sm-6 col-12">
                                        <div class="mb-3">
                                            ...
                                            <div class="input-group control-dark"><input type="text"
                                                                                         class="form-control datepicker-time-24"><span
                                                    class="input-group-text"><i class="icon-date_range"></i></span>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-xl-4 col-lg-4 col-md-6 col-sm-6 col-12">
                                        <div class="mb-3">
                                            ...
                                            <div class="input-group control-dark"><input type="text"
                                                                                         class="form-control datepicker-time-seconds"><span
                                                    class="input-group-text"><i class="icon-date_range"></i></span>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="row gutters">
                                    <div class="col-xl-4 col-lg-4 col-md-6 col-sm-6 col-12">
                                        <div class="mb-3">
                                            ...
                                            <div class="input-group control-dark"><input type="text"
                                                                                         class="form-control datepicker-range"><span
                                                    class="input-group-text"><i class="icon-date_range"></i></span>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-xl-4 col-lg-4 col-md-6 col-sm-6 col-12">
                                        <div class="mb-3">
                                            ...
                                            <div class="input-group control-dark"><input type="text"
                                                                                         class="form-control datepicker-range-auto-apply"><span
                                                    class="input-group-text"><i class="icon-date_range"></i></span>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-xl-4 col-lg-4 col-md-6 col-sm-6 col-12">
                                        <div class="mb-3">
                                            ...
                                            <div class="input-group control-dark"><input type="text"
                                                                                         class="form-control datepicker-range-week-numbers"><span
                                                    class="input-group-text"><i class="icon-date_range"></i></span>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-xl-4 col-lg-4 col-md-6 col-sm-6 col-12">
                                        <div class="mb-3">
                                            ...
                                            <div class="input-group control-dark"><input type="text"
                                                                                         class="form-control datepicker-range-iso-week-numbers"><span
                                                    class="input-group-text"><i class="icon-date_range"></i></span>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-xl-4 col-lg-4 col-md-6 col-sm-6 col-12">
                                        <div class="mb-3">
                                            ...
                                            <div class="input-group control-dark"><input type="text"
                                                                                         class="form-control datepicker-range-time"><span
                                                    class="input-group-text"><i class="icon-date_range"></i></span>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-xl-4 col-lg-4 col-md-6 col-sm-6 col-12">
                                        <div class="mb-3">
                                            ...
                                            <div class="input-group control-dark"><input type="text"
                                                                                         class="form-control datepicker-range-time-24"><span
                                                    class="input-group-text"><i class="icon-date_range"></i></span>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-xl-4 col-lg-4 col-md-6 col-sm-6 col-12">
                                        <div class="mb-3">
                                            ...
                                            <div class="input-group control-dark"><input type="text"
                                                                                         class="form-control datepicker-range-right"><span
                                                    class="input-group-text"><i class="icon-date_range"></i></span>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-xl-4 col-lg-4 col-md-6 col-sm-6 col-12">
                                        <div class="mb-3">
                                            ...
                                            <div class="input-group control-dark"><input type="text"
                                                                                         class="form-control datepicker-range-left"><span
                                                    class="input-group-text"><i class="icon-date_range"></i></span>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-xl-4 col-lg-4 col-md-6 col-sm-6 col-12">
                                        <div class="mb-3">
                                            <div class="form-label">Date Range Opens Top Right</div>
                                            <div class="input-group control-dark"><input type="text"
                                                                                         class="form-control datepicker-range-top-right"><span
                                                    class="input-group-text"><i class="icon-date_range"></i></span>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-xl-4 col-lg-4 col-md-6 col-sm-6 col-12">
                                        <div class="mb-3">
                                            ...
                                            <div class="input-group control-dark"><input type="text"
                                                                                         class="form-control datepicker-range-top-left"><span
                                                    class="input-group-text"><i class="icon-date_range"></i></span>
                                            </div>
                                        </div>
                                    </div>
